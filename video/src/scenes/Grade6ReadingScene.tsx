...
import { reading } from "../data/grade6";

// Beat lengths mirror the narration's word distribution within the reading
// paragraph (see video/NARRATION-TIMING-grade6.md). Reading's distribution
// levels aren't spoken in the script, so that chart appears as a silent
// supporting visual during the closing beat rather than being narration-synced.
const PROFICIENCY_BEAT = 660;
const CLOSING_BEAT = 491;
export const READING_DURATION = PROFICIENCY_BEAT + CLOSING_BEAT;

const PROFICIENCY_TIMINGS = [
  { yearFrame: 75, valueFrame: 226 }, // "نسبة الإتقان بدأت من 42.5 بالمئة عام 2023"
  { yearFrame: 226, valueFrame: 396 }, // "...81.4 بالمئة عام 2025"
  { yearFrame: 396, valueFrame: 660 }, // "...61.7 بالمئة فقط، بانخفاض قدره 19.7 نقطة"
];
const PROFICIENCY_BADGE_FRAME = 625;
...
const ClosingBeat: React.FC = () => (
  <AbsoluteFill style={{ alignItems: "center", justifyContent: "center" }}>
    ...
    <div style={{ width: 1500, display: "flex", flexDirection: "column", gap: 22 }}>
      ...
      <Callout text="تراجع حاد خلال عام واحد — مؤشر يحتاج تدخلاً عاجلاً" from={280} tone="warning" />
    </div>
  </AbsoluteFill>
);

export const Grade6ReadingScene: React.FC = () => {
  return (
    <AbsoluteFill style={{ background: brand.paper }}>
      <Grade6SceneChrome sectionTitle="القراءة" />
