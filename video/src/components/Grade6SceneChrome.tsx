...
/**
 * Same chrome as components/SceneChrome.tsx, duplicated (not imported) so
 * grade-3 scenes and their shared component stay completely untouched.
 * Keep both in sync manually if the chrome design changes.
 */
export const Grade6SceneChrome: React.FC<{
  sectionTitle: string;
  from?: number;
}> = ({ sectionTitle, from = 0 }) => {
