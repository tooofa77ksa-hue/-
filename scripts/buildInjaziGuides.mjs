/*
  ...
  • لا تظهر أي كلمة مرور أو مفتاح أو رمز دخول في أي صفحة.
*/
...
for (const t of ["t01-login","t02-login-filled","t03-portal","t04-filters",
...
<div class="toc">
  <div class="toc__row"><span class="toc__n">١</span><span class="toc__t">الدخول إلى البوابة</span><span class="toc__d">بريدك وكلمة مرورك</span></div>
...
tpage("", "١ · الدخول إلى البوابة", `
<h2><span class="num">١</span>الدخول إلى البوابة</h2>
<p class="sub">بريدٌ وكلمة مرور تستلمينهما من المشرفة.</p>

<div class="steps">
  <div class="step">افتحي <span class="k">${SITE}</span> ثم اضغطي
  <span class="k">دخول</span> في أعلى الصفحة، واختاري <b>بوابة المعلمات</b>.</div>
  <div class="step">اكتبي <b>بريدك الإلكتروني</b> الذي سجّلته به المشرفة.</div>
  <div class="step">اكتبي <b>كلمة المرور</b>.</div>
  <div class="step">اضغطي <span class="k">دخول</span>.</div>
</div>

${wide("t01-login", "صفحة دخول بوابة المعلمات.")}
`);

tpage("", "١ · الدخول إلى البوابة", `
${wide("t02-login-filled", "البريد وكلمة المرور — كلمة المرور لا تظهر أبدًا على الشاشة. (البريد في الصورة مثالٌ توضيحي؛ استخدمي بريدك أنتِ.)")}

<div class="box box--safe"><div class="box__t">🔒 كلمة مرورك مسؤوليّتك</div>
<ul>
  <li>لا تشاركيها مع أحد — ولا مع طالباتك.</li>
  <li>لا تكتبيها في ورقة على المكتب أو في مجموعة واتساب.</li>
  <li>إن نسيتِها فاضغطي <strong>«نسيت كلمة المرور»</strong> — تصلك رسالة على بريدك.</li>
  <li>على جهاز مشترك: سجّلي الخروج بعد الانتهاء.</li>
</ul></div>

<h3>لم أستطع الدخول — ما السبب؟</h3>
<table>
<tr><th>ما يظهر لكِ</th><th>السبب والحل</th></tr>
<tr><td>«البريد أو كلمة المرور غير صحيحة»</td>
<td>راجعي البريد حرفًا حرفًا (بلا مسافة في آخره)، وتأكّدي من لغة لوحة المفاتيح ومن مفتاح Caps Lock</td></tr>
<tr><td>«تعذّر الاتصال»</td>
<td>الإنترنت منقطع أو ضعيف — أعيدي المحاولة بعد عودته</td></tr>
<tr><td>دخلتُ لكن بلا مادة</td>
<td>حسابك لم يُربط بمادتك بعد — تواصلي مع المشرفة</td></tr>
<tr><td>نسيتُ كلمة المرور</td>
<td>«نسيت كلمة المرور» في صفحة الدخول، أو اطلبي من المشرفة تعيينها من جديد</td></tr>
</table>
`);
...
<tr><td><strong>اسمك ومادّتك</strong></td><td>في الأعلى — تأكيدٌ أنكِ في الحساب الصحيح</td></tr>
...
<div class="qa__a">إمّا أن طالباتك لم يرفعن شيئًا بعد في مادّتك، أو أن حسابك غير
مربوطٍ بالمادة الصحيحة. تواصلي مع المشرفة للتأكّد من ربط حسابك بمادّتك.</div></div>
...
<div class="qa"><div class="qa__q">نسيت كلمة المرور.</div>
<div class="qa__a">اضغطي «نسيت كلمة المرور» في صفحة الدخول — تصلك رسالة على بريدك
لإعادة تعيينها. أو تواصلي مع المشرفة.</div></div>
`);
...
<ul>
  ...
  <li>كلمة مرورك لا تظهر على الشاشة ولا تُحفظ في أي صفحة.</li>
</ul></div>
