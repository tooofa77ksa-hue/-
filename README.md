...
## فيديوهات ترويجية/تعليمية

مشروع منفصل مستقل في `remotion/` (لا يؤثر على بناء التطبيق ولا تبعياته)
لإنتاج فيديوهات بالكود عبر [Remotion](https://www.remotion.dev)، بنفس رموز
الهوية البصرية وشخصية «دَمبل». التفاصيل والاستخدام في `remotion/README.md`.
