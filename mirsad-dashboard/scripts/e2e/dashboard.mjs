...
try {
  ...
  check('أسماء الفصول كما تسمّيها المدرسة',
    roomNames[0] === 'الصف أول 1' && roomNames[11] === 'الصف سادس 2',
    roomNames.join(' · '))

  // الترتيب على رقم الصف لا على اسمه: الأبجدي يضع «الثالث» قبل «الثاني»
  const ORDER = ['أول 1', 'أول 2', 'ثاني 1', 'ثاني 2', 'ثالث 1', 'ثالث 2',
    'رابع 1', 'رابع 2', 'خامس 1', 'خامس 2', 'سادس 1', 'سادس 2']
  check('الترتيب من الصف أول 1 إلى الصف سادس 2',
    roomNames.every((n, i) => n === `الصف ${ORDER[i]}`))
